<?php include 'includes/header.php'; ?>	
  ...
  <?php include 'includes/reportfunctions.php'; ?>  
    ...
    <div class="container-fluid">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><?php echo findnosales(); ?> Shitje te reja!</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="sales.php">
              <span class="float-left">Shitjet Detaje</span>
      ...
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-bar-chart"></i> Bar Chart Example - Shitjet per muaj</div>
            <div class="card-body">
              <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-pie-chart"></i> Pie Chart Example - Shitjet sipas trajnimeve</div>
            <div class="card-body">

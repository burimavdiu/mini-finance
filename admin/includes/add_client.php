				...
				<legend class="h6 alert alert-secondary">Të dhënat fiskale të klientin</legend>
					<div class="form-row">	
						<div class="form-group col-md-6">
							...
							<input  name="clientRegistrationNo" class="form-control" id="clientRegistrationNo" type="text" aria-describedby="telefoniHelp" data-error="Please enter name field." required />
						</div>
						<div class="form-group col-md-6">
					...
					<div class="form-row">	
						<div class="form-group col-md-6">
							...
							<input name="registrar" class="form-control" id="registrar" type="text" required />
						</div>
						<div class="form-group col-md-6">
